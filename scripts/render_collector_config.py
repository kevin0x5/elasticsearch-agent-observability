...
def render_config(discovery: dict, *, es_url: str, index_prefix: str, environment: str, service_name: str) -> str:
...
exporters:
  elasticsearch:
    ...
    metrics_index: {index_prefix}-metrics-default
...
service:
  pipelines:
    traces:
      receivers: [otlp]
      processors: [memory_limiter, attributes/runtime, attributes/redact, batch]
      exporters: [elasticsearch]
    metrics:
      receivers: [otlp]
      processors: [memory_limiter, attributes/runtime, batch]
      exporters: [elasticsearch]
    logs:
      receivers: [otlp]
      processors: [memory_limiter, attributes/runtime, attributes/redact, batch]
